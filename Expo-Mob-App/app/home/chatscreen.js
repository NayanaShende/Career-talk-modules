...
// ✅ Deduplicate messages by id to prevent socket + DB double rendering
...
export default function ChatScreen() {
  ...
  // ✅ Get global socket from NotificationContext — NO new socket created here
  ...
  const handleSend = async () => {
    // ✅ Prevent double-send from fast taps
  ...
  // ✅ Use global socket from NotificationContext — no new socket created
  useEffect(() => {
    ...
    // ✅ Check online status from global socket connection
    ...
    return () => {
      ...
      // ✅ Do NOT disconnect — this is the shared global socket
    };
  }, [currentUserId, RECEIVER_ID, globalSocketRef]);
